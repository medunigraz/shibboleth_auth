...
if ($_EXTCONF['enableBE']) {
    ...
    if (TYPO3_MODE == 'BE') {
        ...
        $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_userauth.php']['logoff_post_processing'][] = \MUG\ShibbolethAuth\Hook\UserAuthentication::class . '->backendLogoutHandler';
    }

    $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['backend']['loginProviders'][1518433441] = [
        'provider' => \MUG\ShibbolethAuth\LoginProvider\ShibbolethLoginProvider::class,
        'sorting' => 60,
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addService(
    $_EXTKEY,
    'auth',
    \MUG\ShibbolethAuth\Typo3\Service\ShibbolethAuthenticationService::class,
    [
        ...
        'className' => \MUG\ShibbolethAuth\Typo3\Service\ShibbolethAuthenticationService::class,
    ]
);
